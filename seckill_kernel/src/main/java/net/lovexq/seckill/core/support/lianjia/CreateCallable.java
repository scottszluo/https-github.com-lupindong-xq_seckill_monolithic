 ...
 */
public class CreateCallable implements Callable<JsonResult> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateCallable.class);
    ...
    public CreateCallable(LianJiaParam lianJiaParam, MqProducer mqProducer, Queue queue) {
